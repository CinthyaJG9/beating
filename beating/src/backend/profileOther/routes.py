...
profileOther_routes = Blueprint('profileOther_routes', __name__)

# 1. Ruta para obtener la información básica del usuario:
# URL: /api/usuarios/{userId}
@profileOther_routes.route('/api/usuarios/<string:user_id>', methods=['GET'])
@token_required
...
@profileOther_routes.route('/api/resenas/usuario/<string:user_id>', methods=['GET'])
@token_required
...
@profileOther_routes.route('/api/usuarios/<string:user_id>/seguidos', methods=['GET'])
@token_required
...
@profileOther_routes.route('/api/usuarios/<string:user_id>/estadisticas', methods=['GET'])
@token_required
