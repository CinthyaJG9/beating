...
export default function ProfileB() {
  ...
  const cargarDatosUsuario = async () => {
    try {
      ...
      if (resenasResponse.ok) {
        ...
        console.log("Datos de reseñas recibidos:", resenasData);
  ...
  // Colores vibrantes pero con buen contraste
  ...
  // FUNCIÓN CORREGIDA: Reescalar de 0-1 a 0-5
  const reescalarPuntuacion = (puntuacion) => {
    if (puntuacion === null || puntuacion === undefined) return 0;
    
    // Si la puntuación está entre 0 y 1, reescalar a 0-5
    if (puntuacion >= 0 && puntuacion <= 1) {
      return puntuacion * 5;
    }
    
    // Si ya está entre 0-5, usar directamente
    return puntuacion;
  };

  // Obtener estrellas llenas basado en la puntuación reescalada
                    ...
                    return (
                      ...
                      >
                        <CardContent className="relative z-10 p-6 h-full flex flex-col">
                          ...
                          <div className="mb-4">
                            {/* TÍTULO Y ARTISTA CON MEJOR VISIBILIDAD */}
                            <div className="flex items-start gap-3 mb-4">
                              ...
                              <div className="flex-1 min-w-0">
                                {/* TÍTULO CON ALTO CONTRASTE Y MEJOR VISIBILIDAD */}
                            ...
                            {/* Sentimiento y puntuación en una sola línea */}
